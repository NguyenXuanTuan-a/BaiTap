    ...
    <div class="wrapper">
        <header id="htc__header" class="htc__header__area header--one">
            <div id="sticky-header-with-topbar" class="mainmenu__wrap sticky__header">
                <div class="container" style="padding-right: 0; width:85% ; padding-left:0">
                    <div class="row" >
                        <div class="menumenu__container clearfix" >
                            <div class="col-lg-2 col-md-2 col-sm-3 col-xs-5"> 
                                <div class="logo">
                                     <a href="index.php"><img src="images/logo/logo.png" alt="logo images" style="height: 80px"></a>
                                </div>
                            </div>
                                ...
                                <nav class="main__menu__nav hidden-xs hidden-sm">
                                    <ul class="main__menu" >
										...
										foreach($cat_arr as $list){
											...
											<?php
											$cat_id=$list['id'];
											$sub_cat_res=mysqli_query($con,"select * from sub_categories where status='1' and id_categories='$cat_id'");
										...
										?>
                                        <li><a href="contact.php">Kết Nối</a></li>
                                    </ul>
                                </nav>
                                ...
                                <div class="header__right">
                                    ...
                                    <div class="header__account">
										<?php if(isset($_SESSION['USER_LOGIN'])){
												...
												<ul class="navbar-nav mr-auto">
												  <li class="nav-item dropdown">
													...
													<div class="dropdown-menu" aria-labelledby="navbarDropdown">
													  <a class="dropdown-item" href="my_order.php">Đơn hàng</a>
											...
											echo '<a href="login.php" class="mr15">Đăngnhập/Đăngký</a>';
										}
										?>
