                        ...
                        <form method="post" enctype="multipart/form-data">
							<div class="card-body card-block">
								...
								<div class="form-group">
									<label for="categories" class=" form-control-label">Mã Code</label>
									<input type="text" name="coupon_code" placeholder="Mã Code" class="form-control" required value="<?php echo $coupon_code?>">
								</div>
								<div class="form-group">
									<label for="categories" class=" form-control-label">Giá Trị</label>
									<input type="text" name="coupon_value" placeholder="Giá Trị" class="form-control" required value="<?php echo $coupon_value?>">
								</div>
								<div class="form-group">
									<label for="categories" class=" form-control-label">Loại Mã</label>
									<select class="form-control" name="Loại Mã" required>
										<option value=''>Select</option>
										<?php
										if($coupon_type=='Percentage'){
											echo '<option value="Percentage" selected>Phần trăm</option>
												<option value="Rupee">$Đôla</option>';
										}elseif($coupon_type=='Rupee'){
											echo '<option value="Percentage">Phần trăm</option>
												<option value="Rupee" selected>$Đôla</option>';
										}else{
											echo '<option value="Percentage">Phần trăm</option>
												<option value="Rupee">$Đôla</option>';
										}
								...
								<div class="form-group">
									<label for="categories" class=" form-control-label">Giá Trị Thấp Nhất</label>
									<input type="text" name="cart_min_value" placeholder="Giá Trị Thấp Nhất" class="form-control" required value="<?php echo $cart_min_value?>">
								</div>
