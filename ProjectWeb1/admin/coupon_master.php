	...
	<div class="orders">
	   <div class="row">
		  <div class="col-xl-12">
			 <div class="card">
				<div class="card-body">
				   <h4 class="box-title">Mã giảm giá</h4>
				   <h4 class="box-link"><a href="manage_coupon_master.php">Thêm mã giảm giá</a> </h4>
				</div>
				<div class="card-body--">
					  ...
					  <table class="table ">
						 <thead>
							<tr>
							   ...
							   <th width="20%">Loại Mã</th>
							   <th width="13%">Giá Trị Thấp Nhất</th>
							   <th width="23%"></th>
							</tr>
						 </thead>
						 <tbody>
