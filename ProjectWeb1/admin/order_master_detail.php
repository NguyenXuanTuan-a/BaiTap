					  ...
					  <table class="table">
								...
								<tbody>
									...
									<tr>
										...
										<td class="product-name"> <img src="<?php echo $img.$row['image']?>"></td>
									...
									<tr>
										<td colspan="3"></td>
										<td class="product-name">Giá trị mã giảm giá</td>
							...
							<div>
								<form method="post">
									<select class="form-control" name="update_order_status" id="update_order_status" required onchange="select_status()">
										<option value=""  disable selected hidden>Select Status</option>
										<?php
