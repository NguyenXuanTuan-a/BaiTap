	...
	<div class="orders">
	   <div class="row">
		  <div class="col-xl-12">
			 <div class="card">
				<div class="card-body">
				   <h4 class="box-title">Đặt Hàng </h4>
				</div>
				<div class="card-body--">
					  ...
					  <table class="table">
							<thead>
								<tr>
									...
									<th class="product-stock-stauts"><span class="nobr">Thanh Toán </span></th>
									<th class="product-stock-stauts"><span class="nobr"> Tình trạng thanh toán </span></th>
									<th class="product-stock-stauts"><span class="nobr"> Trạng Thái Đơn </span></th>
									<th class="product-stock-stauts"><span class="nobr"> Gửi Hàng</span></th>
								</tr>
							</thead>
							<tbody>
								<?php
								...
								<tr>
									<td class="product-add-to-cart">
									 <?php echo $row['id']?><br/>
									<a href="../order_pdf.php?id=<?php echo $row['id']?>">PDF</a><br/>
									<a href="order_master_detail.php?id=<?php echo $row['id']?>">Chi tiết đơn hàng</a>
									</td>
